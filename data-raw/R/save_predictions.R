...
predictions <- bind_rows(predictions_ov, predictions_lg, predictions_pt) |>
  data.frame()
...
risk_rank_pt <- tab10:::create_framedata("preterm-32w", ntab = 1000, seed = 4)
risk_rank_pt$pct <- (risk_rank_pt$pct - 1) / 100
