make_coordinates <- function(script, case, p, centile = TRUE, ntab = 100) {
  ...
  if (ntab == 10000) {
    return(make_coordinates_10000(script = script, case = case, p = p, centile = centile))
  }
}

make_coordinates_10000 <- function(script, case, p, centile = TRUE) {
  ...
  stopifnot(length(case) == 10000L || length(p) == 10000L)
